        ...
        public static string ErzeugeTabelle(List<List<string>> tableData, string borderStyle = "Komplettes Gitter")
        {
            ...
            for (int i = 0; i < tableData.Count; i++)
            {
                ...
                for (int j = 0; j < columnCount; j++)
                {
                    ...
                    // Erste Spalte farbig bei Kopfzellen-Hervorhebung
...
//                {
//                    // Inhalt der Zelle (evtl. leer)
//                    string cell = j < row.Count ? ErsetzeSonderzeichen(row[j]) : ""; // ErsetzeSonderzeichen macht Sonderzeichen LaTeX-kompatibel
